export const culture = {
    questions: [//questions est une propriété [
      {
      ...
      },
      {
        ...
        options: [
          "Le fait de se méfier du progrès technologique",
          "Passion de jeux de sociétés",
          "Un courant du Christianisme",
          "Une technique de forge médiévale Européenne"
        ],
        correct_answer: "Le fait de se méfier du progrès technologique"
      },
      {
